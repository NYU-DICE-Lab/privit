...
parser.add_argument('--model_type', '-mt', help='ViT model to use', default='google/vit-base-patch16-224-in21k', choices=['google/vit-base-patch16-224-in21k', 'google/vit-large-patch16-224-in21k','WinKawaks/vit-small-patch16-224','WinKawaks/vit-tiny-patch16-224'])
...
def main(args):
    ...
    # Deepcopy the model and change the layers
    ...
    for epoch in range(args.epochs):
        ...
        train_loss = mask_train_kd(train_loader, net, None, criterion, optimizer, epoch, device, args.alpha_gelu, args.alpha_softmax,args.cutmix_prob)
        ...
        penalty_flag_softmax = lowest_softmax_count - softmax_count <200  and not frozen_softmax # to avoid penalizing once budget has reached
        penalty_flag_gelus = lowest_relu_count - relu_count <2  and not frozen_gelu
